...
export const projects = {
  "redefine-foods": {
    displayTitle: "Я СТАРАЛСЯ НО МЕНЯ НЕ НАПЕЧАТАЛИ. Книга по С.Д.Довлатову",
    description:
      "Концептуальный подход: книга как цепочка коротких фраз и визуальных пауз, отражающая ироничный и честный тон Довлатова. Текст фрагментарен — так устроена память о человеке, которого мы знаем по обрывкам. Визуальный стиль построен на минимализме и намеренно оставленном пустом пространстве как инструменте повествования: паузы работают так же, как слова. Название отсылает и к биографии Довлатова, и к универсальному опыту непризнанного автора.",
    year: "2026",
    services: ["Вёрстка"],
  ...
  "neighborhood-design": {
    ...
    description: "В рамках проекта Freepik «Neighborhood Design» в Сан-Франциско я возглавила редизайн барбершопа Razo’s: новая айдентика, витрина, интерьер и мерч — чтобы бренд ближе говорил с жителями района Excelsior.",
    year: "04/2024",
    services: ["Ребрендинг"],
