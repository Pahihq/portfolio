...
export const projects = {
  "redefine-foods": {
    displayTitle: "Redefine Foods™",
    description: "Redefine Foods™ offers various protein snacks, ranging from pies to donuts. Their mission is to reinvent the snacks that filled our childhoods with joy into a healthier alternative",
    year: "Current",
    services: ["Packaging", "Brand Identity"],
    tools: ["Figma", "Illustrator", "Photoshop", "Dimension"],
    images: ["https://framerusercontent.com/images/kkGYQEXbbFkYLZUeaiMrxM4F8rg.png?width=4480&height=3360", "https://framerusercontent.com/images/pXWBN734veSyunn4CSKxmd8xQ.png?width=2200&height=1652", "https://framerusercontent.com/images/X2LmGPJhg0iyvEdcZ7dAsCkies.png?width=2200&height=1652", "https://framerusercontent.com/images/xPXmrBV8q1yytE6Cqo1nRgXcwE.png?width=2200&height=1652", "https://framerusercontent.com/images/f801sNeSogzuhbezdZkERZqx1Kk.png?width=2200&height=1652", "https://framerusercontent.com/images/wpiKXTMCsV5VEek57NGKAq88O04.png?width=2200&height=1652", "https://framerusercontent.com/images/DeeUx2GJIeipXxGiEWQ3Ho1fdk.png?width=2200&height=1652", "https://framerusercontent.com/images/iJ6Be9pNDxvwPwTxYyS76fvAYKk.png?width=4480&height=3360", "https://framerusercontent.com/images/8tS1IHwUlMIeyHYxED5i5XV3Q.png?width=1284&height=961", "https://framerusercontent.com/images/tMURh8HDT6Vj6Y6a6ssnErcdcI.png?width=4480&height=3360", "https://framerusercontent.com/images/8WZJClAThtWHTXpEunaoEjfRGI.png?width=4480&height=3360"],
  },
  "alienography": {
    displayTitle: "Alienography",
    description: "In what ways can visual communication techniques be utilized to visualize a personal experience of being an alien in a foreign country?",
    year: "05/2023",
    services: ["Type Design", "Installation"],
  ...
  "neighborhood-design": {
    ...
    description: "Participating in Freepik’s \"Neighborhood Design\" project in San Francisco, I led the redesign of Razo’s Barber Shop, creating a fresh visual identity and updating its storefront, interiors, and merchandise to better connect with the Excelsior District community",
    year: "04/2024",
    services: ["Re-branding"],
    tools: ["Freepik AI", "Figma", "Photoshop", "Illustrator"],
  ...
  "park-me": {
    displayTitle: "ParkMe",
    description: "An app designed to help drivers simplify the process of locating suitable parking spots near their destination",
    year: "04/2024",
  ...
  "atoms": {
    displayTitle: "Atoms",
    description: "Educational platform to foster college students to form teams for collaborative projects and enhance their networking opportunities. Collaborated with Leo Baek, Joy Ham, and Sunjoo Park",
    year: "07/2023",
    services: ["UI/UX Design"],
  ...
  "miller-knoll": {
    ...
    description: "Rebranding for MKWRL (MillerKnoll Workplace Research Library) with the concept of stacked files that functions as an archive",
    year: "04/2023",
  ...
  "spy": {
    displayTitle: "SPY",
    description: "International Spy Museum brand identity redesign",
    year: "04/2024",
    services: ["Brand Identity"],
  ...
  "qahira": {
    displayTitle: "Qahira",
    description: "Introducing Qahira, a perfume that encapsulates the essence of victory in every drop. Designed to serve as more than just a fragrance, Qahira is a reminder to enjoy the moment and acknowledge your inner strength.",
    year: "05/2023",
    services: ["Packaging", "Brand Identity"],
  ...
  "go-go": {
    displayTitle: "GoGo",
    description: "A travel app designed to reduce stress when planning a multi-destination tour involving multiple members with varying schedules and budgets. Collaborated with Sunjoo Park, Melody Yu, Sua Kim",
    year: "06/2022",
    services: ["UI/UX Design"],
  ...
  "wagging-hearts": {
    ...
    description: "With AHA (American Heart Association), our objective was to focus on promoting the heart benefits of healthy active dog and owner lifestyles. Our pop-up installation was designed to encourage owners to walk their dogs, which would increase their fitness levels and reduce the risk from getting a heart attack. Collaborated with Nicole Lee, Jason Ma",
    year: "05/2023",
    services: ["Brand Identity"],
  ...
  "related-department": {
    ...
    description: "Spreads for an interview with Scarlett Xin Meng, a Graphic Designer and Creative Director at Related Department. Interview conducted with Chaeree Lee",
    year: "04/2024",
    services: ["Publication Design"],
    tools: ["Interviewer", "Photoshop", "InDesign", "Illustrator"],
  ...
  "blue-dragon": {
    displayTitle: "청룡",
    description: "For the KSA (Korean Student Association) New Year party, created a cohesive event branding, covering promotional social media graphics to large scale motion graphic that embodies the year of the Blue Dragon",
    year: "01/2024",
    services: ["3D Renderings", "Installation"],
  ...
  "conversation": {
    ...
    description: "Visual exploration of the dynamic interaction between my mother and me. It highlights one of her frequent sayings—how life consists of both positive and negative moments, but finding balance between them is key",
    year: "12/2023",
    services: ["3D Motion Graphics"],
  ...
  "seen-and-unseen": {
    ...
    description: "Design concept exploration of a music festival spotlighting underrepresented artists, giving them a platform to shine",
    year: "12/2024",
    services: ["Brand Identity", "Concept Design"],
